...
SELECT_RANGE_REPORT = "SELECT * FROM reports WHERE Time BETWEEN ? AND ?"
SELECT_PAST_HOUR_REPORT = "SELECT SUM({0}) AS {0}_PHr FROM reports WHERE Time BETWEEN ? AND ?"
SELECT_RANGE_ENVREPORT = "SELECT * FROM envReports WHERE Time BETWEEN ? AND ?"
SELECT_RANGE_DAYSTAT = "SELECT * FROM dayStats WHERE Date BETWEEN ? AND ?"

SELECT_FIELDS_REPORT = "SELECT {} FROM reports WHERE Time BETWEEN ? AND ?"
SELECT_FIELDS_ENVREPORT = "SELECT {} FROM envReports WHERE Time BETWEEN ? AND ?"
SELECT_FIELDS_DAYSTAT = "SELECT {} FROM dayStats WHERE Date BETWEEN ? AND ?"
