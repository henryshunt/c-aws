...
def data_climate():
    ...
    data["MSLP_Avg_Months"] = copy.deepcopy(fill_value)
    data["ST10_Avg_Months"] = copy.deepcopy(fill_value)
    data["ST30_Avg_Months"] = copy.deepcopy(fill_value)
    data["ST00_Avg_Months"] = copy.deepcopy(fill_value)
