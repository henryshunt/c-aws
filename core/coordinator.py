...
class Coordinator():
    ...
    def startup(self):
        ...
        self._clock = Clock(14)
        self._clock.open()
        self._clock.on_tick = self.on_tick

        helpers.log(self._clock.get_time(), "coord", "Opened connection to clock")
    ...
    def file_system(self):
        ...
        if free_space == None or free_space < 0.1:
            helpers.log(self._clock.get_time(), "coord", "Not enough free space")
            return False
        ...
        try:
            ...
            helpers.log(self._clock.get_time(), "coord", "Failed to create directory")
            return False

        helpers.log(self._clock.get_time(),
        ...
        try:
            if not os.path.isfile(config.main_db_path):
                ...
                helpers.log(self._clock.get_time(), "coord", "Created main database")
        except:
            helpers.log(self._clock.get_time(), "coord", "Failed to create main database")
            return False
        ...
        if (config.report_uploading == True or
            ...
            try:
                if not os.path.isfile(config.upload_db_path):
                    ...
                    helpers.log(self._clock.get_time(), "coord", "Created transmit database")
            except:
                helpers.log(self._clock.get_time(), 
